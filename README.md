...
Для реализации обновления данных в реальном времени, административная часть используется подключение по **websocket**.
...
В момент присвоения нового статуса администратор так же может присвоить ключу имя, во всплывающем диалоговом окне.
...
2. Далее клиент отправляет сгенерированный ключ, сервер его регистрирует.  
